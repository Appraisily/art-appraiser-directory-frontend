...
const MAX_IMAGES_TO_GENERATE = 10; // Generate 10 images
...
const main = async () => {
  try {
    console.log('Starting image generation for placeholder images...');
    ...
    while (successCount < MAX_IMAGES_TO_GENERATE && processedCount < appraisers.length) {
